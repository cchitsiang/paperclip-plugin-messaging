...
const manifest: PaperclipPluginManifestV1 = {
  ...
  displayName: "Messaging Bot",
  description:
    "Bidirectional messaging integration: push notifications, bot commands, escalation to humans, multi-agent sessions (native + ACP), media pipeline with transcription, custom workflow commands, and proactive suggestion watches.",
  author: "mvanhorn",
